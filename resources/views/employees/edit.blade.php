        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data" id="employeeForm">
                ...
                <div class="col-md-6">
                    <div class="mb-4">
                        ...
                        <select class="form-select searchable-select @error('position_id') is-invalid @enderror" 
                                ...
                                name="position_id" 
                                required>
                            <option value="" {{ (old('position_id', $employee->position_id) == '' || old('position_id', $employee->position_id) === null) ? 'selected' : '' }}>-- Pilih Jabatan --</option>
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          required>{{ old('description', $employee->description) }}</textarea>
                @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
