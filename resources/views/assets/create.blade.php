                ...
                <form action="{{ route('assets.store') }}" method="POST" enctype="multipart/form-data" id="assetForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  name="description"
                                  rows="3"
                                  placeholder="Deskripsi aset...">{{ old('description') }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('asset_type') is-invalid @enderror" id="asset_type" name="asset_type" required>
                                    ...
                                    <option value="phone" {{ old('asset_type') == 'phone' ? 'selected' : '' }}>Telepon</option>
                                    <option value="tablet" {{ old('asset_type') == 'tablet' ? 'selected' : '' }}>Tablet</option>
                                    <option value="equipment" {{ old('asset_type') == 'equipment' ? 'selected' : '' }}>Peralatan</option>
                                    <option value="vehicle" {{ old('asset_type') == 'vehicle' ? 'selected' : '' }}>Kendaraan</option>
                                    <option value="furniture" {{ old('asset_type') == 'furniture' ? 'selected' : '' }}>Furnitur</option>
                                    <option value="other" {{ old('asset_type') == 'other' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                                @error('asset_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    ...
                                    <option value="assigned" {{ old('status') == 'assigned' ? 'selected' : '' }}>Ditetapkan</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    assignedTo.addEventListener('change', function() {
        if (this.value) {
            ...
            document.getElementById('assigned_date').required = true;
        } else {
            assignedDateGroup.style.display = 'none';
            document.getElementById('assigned_date').required = false;
        }
    });
